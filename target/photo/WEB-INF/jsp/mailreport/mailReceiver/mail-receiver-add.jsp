	...
	<div class="page-content clearfix">
		...
		<div class="c-right fl">
			<div class="tablistbox">
				<span class="anas-type">邮件报表_收件人管理_增加</span>
			</div>
			<div id="maingrid" style="margin: 0; padding: 0; float: left; width: 100%; margin-top: 5px">
				...
				<table id="contentlist" class="table table-striped table-bordered bootstrap-datatable datatable">
					<tr>
						...
						<td ><input type="text"  id="mailReceiverName" name="mailReceiver.name" style="width: 300px;"/></td>
					</tr>
					<tr>
						<td >收件人:</td>
						<td ><textarea rows="12" id="mailReceivermailAddress" name="mailReceiver.mailAddress" style="width: 600px;"></textarea> &nbsp;多个邮箱以","隔开</td>
					</tr>
					<tr><td colspan="2">
...
<script>
	function save(){
		...
		$.ajax({
		    url: "${ctx}/mailreport/addMailReceiver.action?"+$("#tef").serialize(),
