...
.tbldt-bd td {
	...
	<div class="page-content clearfix">
		...
		<form action="${ctx}/parameter/clientDefineEdit.action" method="post" id="dataForm" onkeydown="if(event.keyCode==13){return false;}">
		<input id="app_id"  type="hidden"   name="clientDefine.app_id" value="${clientDefine.app_id}"/>
		<div class="c-right fl">
			<div class="tablistbox">
				<span class="anas-type">编辑-客户端定义</span>
			...
			<tbody class="tbldt-bd">
					<tr>
						...
						<input   type="text" disabled="disabled"  class="ex-searchinput" style="width: 200px"   value="${clientDefine.app_id}"/>
						</td>
					...
					<tr>
						...
						<td style="width:200px" align="left">
						<input id="name"  type="text" class="ex-searchinput" style="width: 200px" name="clientDefine.name" value="${clientDefine.name}"/>
						</td>
					...
					<%-- <tr>
						...
						<td style="width:200px" align="left">
						<input id="ugc_data"  type="text" class="ex-searchinput" style="width: 200px" name="clientDefine.ugc_data" value="${clientDefine.ugc_data}"/>
						</td>
					...
					<tr>
						...
						<td style="width:200px" align="left">
							<input id="status2"  type="radio" class="ex-searchinput" style="width: 200px" name="clientDefine.status" value="1" <c:if test="${1==clientDefine.status}">checked="checked"</c:if> />有效
							<input id="status1"  type="radio" class="ex-searchinput" style="width: 200px" name="clientDefine.status" value="0" <c:if test="${0==clientDefine.status}">checked="checked"</c:if> />无效
						</td>
					...
					<%-- <tr>
						...
						<td style="width:200px" align="left">
						<input id="type"  type="text" class="ex-searchinput" style="width: 200px" name="clientDefine.type" value="${clientDefine.type}"/>
						</td>
					...
					<tr>
						...
						<td style="width:200px" align="left">
						<input id="show_active"  type="text" class="ex-searchinput" style="width: 200px" name="clientDefine.show_active" value="${clientDefine.show_active}"/>
						</td>
							...
							<select name="clientDefine.os_id"   style="width: 120px" id="os_id">
								<c:if test="${!empty platfromList}">
									<c:forEach items="${platfromList}" var="entity">
										<option value="${entity.id}" <c:if test="${entity.id==clientDefine.os_id}"> selected="selected"</c:if>>${entity.name}</option>
									</c:forEach>
								</c:if>
							</select>
 						</td>
					...
					<tr>
						...
						<td style="width:200px" align="left">
							<input id="is_tool_1"  type="radio" class="ex-searchinput" style="width: 200px" name="clientDefine.is_tool" value="1" <c:if test="${1==clientDefine.is_tool}">checked="checked"</c:if> />是
							<input id="is_tool_2"  type="radio" class="ex-searchinput" style="width: 200px" name="clientDefine.is_tool" value="0" <c:if test="${0==clientDefine.is_tool}">checked="checked"</c:if> />否
						</td>
					...
					<tr>
						...
						<td style="width:200px" align="left">
						<input id="source"  type="text" class="ex-searchinput" style="width: 200px" name="clientDefine.source" value="${clientDefine.source}"/>
						</td>
							...
							<select name="clientDefine.device_id"   id="device_id" style="width: 120px">
								<c:if test="${!empty deviceList}">
									<c:forEach items="${deviceList}" var="entity">
										<option value="${entity.id}" <c:if test="${entity.id==clientDefine.device_id}"> selected="selected"</c:if>>${entity.name}</option>
									</c:forEach>
								</c:if>
							</select>
 						</td>
							...
							<select name="clientDefine.project_id"   id="project_id" style="width: 120px">
								<c:if test="${!empty clientProjectDefineVoList}">
									<c:forEach items="${clientProjectDefineVoList}" var="entity">
										<option value="${entity.id}" <c:if test="${entity.id==clientDefine.project_id}"> selected="selected"</c:if>>${entity.name}</option>
									</c:forEach>
								</c:if>
							</select>
 						</td>
